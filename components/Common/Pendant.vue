	...
	<div id="navbar-pendant" class="z-50 fixed right-[10px] opacity-90 top-[60%]">
		<ul>
			<li class="navbar-icon-style text-[#00b140] hover:text-[#008733]">
				...
				>
					<img class="h-[110px] max-w-fit" src="https://img01.anheyu.com/useruploads/156/2023/10/13/65295361e2d46.png" alt="" />
					<p class="text-[chocolate] text-[12px] whitespace-nowrap m-0">欢迎关注公众号"励心缘起"</p>
				</div>
			</li>
			<li class="navbar-icon-style text-[#0088cc] hover:text-[#085b85]">
				<a
				    :href="'http://lead.lxyq.link/'"
		            target="_blank"
			...
			<li class="navbar-icon-style text-[#0088cc] hover:text-[#085b85]">
				<a
				    :href="'https://www.hylove.top/essay/'"
		            target="_blank"
