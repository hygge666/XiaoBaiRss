<template>
	<div class="w-full bg-white">
		...
		>
			...
			>
				<a :href="'http://rss.lxyq.link/'" target="_blank">
					<img class="header-logo transition-all hover:rotate-180" :src="'https://img01.anheyu.com/useruploads/156/2023/12/28/658d1d453ce61.png'" alt="https://img01.anheyu.com/useruploads/156/2023/12/28/658d1d453ce61.png" />
				</a>
				<a
					:href="'http://rss.lxyq.link/'"
					target="_blank"
...
const props = withDefaults(
	...
	{
		headerText: "XiaoBaiRss",
	},
)

// 控制头部变化
const headerAnimation = (action: string) => {
	const headerDom = document.getElementById('XiaoBairss-header')
